...
import io.github.igoroliveira7.libraryapi.validator.AutorValidator;
...
public class AutorService {
    ...
    public void atualizar (Autor autor) {
        if(autor.getId() == null) {
            throw new IllegalArgumentException("Erro ao atualizar! é necessário que o autor já esteja salvo na base");
        }
        validator.validar(autor);
    ...
    public void deletar(Autor autor) {
        if(possuiLivro(autor)) {
            throw new RegistroDuplicadoException("Não é permitido excluir um autor que já possui livros cadastrados!");
        }
